...
defaults_by_cmd = { # 'field':None indicates field is required when assembling command
    ...
    'channelTipPickUp':('PICKUP', {
        ...
        'channelVariable':_channel_patt_12,
    ...
    'mph384TipPickUp':('PICKUP384', {
        'tipSequence':'',
        'labwarePositions':'',
        'channelVariable':_channel_patt_384,
        'sequenceCounting':0,
        'reducedPatternMode':0
    }),

    'mph384TipEject':('EJECT384', {
        'wasteSequence':'',
        'labwarePositions':'',
        'channelVariable':_channel_patt_384,
        'sequenceCounting':0,
    ...
    'mph384Aspirate':('ASPIRATE384', {
        ...
        'mixPosition':0.0,
        'mixVolume':0.0,
        'airTransportRetractDist':10.0
    }),

    'mph384Dispense':('DISPENSE384', {
        'dispenseSequence':'',
        'labwarePositions':'',
        'dispenseVolume':None,
        'channelVariable':_channel_patt_384,
