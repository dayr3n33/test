...
class DevPalLiteApp:
    ...
    def upload_lay(self):
        ...
        try:
            ...
            # Preload the heavier LAY metadata while the user is already in the
            # file-loading step.  This keeps Run Sequence Analyzer from paying
            # that parsing cost immediately before Hamilton Run Control launches.
            self._cached_lay_metadata_path = ""
            self._cached_lay_metadata_mtime = None
            self._cached_lay_metadata = {}
            self.get_cached_lay_metadata()
